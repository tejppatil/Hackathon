...
class Patient:
    def __init__(self):
        self.patient_names = ["Tejas Prakash Patil", "Aashutosh Thakur", "Jampani Komal"]
        self.patient_usernames = ["tejas", "aashutosh", "komal"]
        self.patient_passwords = ["tejas1", "aashutosh1", "komal1"]
        self.patient_phone1s = [7720841778, 8102568219, 9182048179]
        self.patient_phone2s = [0, 9825818717, 9704427177]  # 0 represents phone number not provided
        self.patient_mails = ["tppatil397@gmail.com", "thakuraashutosh13@gmail.com", "jampanikomal2005@gmail.com"]
        self.patient_addresses = ["Home World Hostel, Bhaijipura, Gandhinagar, Gujarat. - 382421"] * 3
        self.patient_bloodgroups = ["B+", "O+", "B+"]
        self.patient_citizenids = ["230031101611052", "230031101611057", "230031101611054"]
        self.patient_uniquecodes = [23052, 23057, 23054]
        self.patient_pastmedicalhistories = ["Cancer", "Sinus", "None"]
    ...
    def login(self):
        ...
        if username in self.patient_usernames:
            index = self.patient_usernames.index(username)
            if self.patient_passwords[index] == password:
                print("\nLogin Successful!")
    ...
    def signup(self):
        ...
        phone2 = int(input("Enter your alternate [Emergency] phone number: "))
        ...
        self.patient_phone1s.append(phone1)
        self.patient_phone2s.append(phone2)
        self.patient_mails.append(mail)
        self.patient_addresses.append(address)
        self.patient_bloodgroups.append(bloodgroup)
        self.patient_citizenids.append(citizenid)
        self.patient_usernames.append(username)
        self.patient_passwords.append(password)
        self.patient_uniquecodes.append(random.randint(1000, 9999))  # Random unique code

        print("\nSign Up Successful!\nVisit nearest hospital to complete KYC to access all features of the app!")
        self.patient_index = len(self.patient_usernames) - 1
    ...
    def view_profile(self):
        ...
        print(f"Username: {self.patient_usernames[index]}")
    ...
    def medicine_search(self):
        ...
        for i, (symptom, _) in enumerate(symptoms):
            print(f"{i + 1}. {symptom}")
